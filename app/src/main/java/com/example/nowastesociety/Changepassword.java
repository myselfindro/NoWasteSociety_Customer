    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Changepassword.this, ResturantList.class);
        ...
        btnFav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Changepassword.this, Myfavourite.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
        ...
        imgSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Changepassword.this, Search.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
        });
...
//
        if (id == R.id.nav_orders) {
            // Handle the camera action
            startActivity(new Intent(Changepassword.this, Myorders.class));
...
//
        if (id == R.id.nav_issue) {
            // Handle the camera action
            startActivity(new Intent(Changepassword.this, Issue.class));
