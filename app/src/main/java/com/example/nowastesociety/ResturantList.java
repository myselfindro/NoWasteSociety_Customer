...
import com.example.nowastesociety.adapter.RestaurantlistAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ResturantList.this, Myfavourite.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
        ...
        imgSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ResturantList.this, Search.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
        });
...
//                        Toast.makeText(HomeActivity.this, msg, Toast.LENGTH_SHORT).show();
    ...
    private void setupRecycler() {
        ...
        restaurantlistAdapter = new RestaurantlistAdapter(this, resturentModelArrayList);
        rv_allresturantList.setAdapter(restaurantlistAdapter);
            ...
            JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.POST, AllUrl.AddtoFav, params, response -> {
                ...
                try {
                    ...
                    if (success) {
                        ...
                        Log.d(TAG, "unsuccessfull - " + "Error");
                        Toast.makeText(ResturantList.this, "Add to Favourite not successfull", Toast.LENGTH_SHORT).show();
                    }
...
//
        if (id == R.id.nav_orders) {
            // Handle the camera action
            startActivity(new Intent(ResturantList.this, Myorders.class));
...
//
        if (id == R.id.nav_issue) {
            // Handle the camera action
            startActivity(new Intent(ResturantList.this, Issue.class));
