...
import com.example.nowastesociety.Myfavourite;
...
//        }
        ...
        holder.btnDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Lat = ((Myfavourite)ctx).getLat();
                String Long = ((Myfavourite)ctx).getLong();
        ...
        holder.btnHeart.setOnLikeListener(new OnLikeListener() {
            ...
            public void unLiked(LikeButton likeButton) {
                ...
                ((Myfavourite) ctx).addTounfavourite(resturentModelArrayList.get(position));
